...
func newOrganizationMembersTableImpl(schemaName, tableName, alias string) organizationMembersTable {
	var (
		...
		allColumns           = postgres.ColumnList{IDColumn, OrganizationIDColumn, UserIDColumn, RoleColumn, JoinedAtColumn}
		mutableColumns       = postgres.ColumnList{OrganizationIDColumn, UserIDColumn, RoleColumn, JoinedAtColumn}
		defaultColumns       = postgres.ColumnList{IDColumn, RoleColumn, JoinedAtColumn}
	)
