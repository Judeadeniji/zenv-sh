...
func newUsersTableImpl(schemaName, tableName, alias string) usersTable {
	var (
		...
		allColumns              = postgres.ColumnList{IDColumn, EmailColumn, AuthKeyHashColumn, VaultKeyTypeColumn, SaltColumn, WrappedDekColumn, PublicKeyColumn, WrappedPrivateKeyColumn, CreatedAtColumn, UpdatedAtColumn}
		mutableColumns          = postgres.ColumnList{EmailColumn, AuthKeyHashColumn, VaultKeyTypeColumn, SaltColumn, WrappedDekColumn, PublicKeyColumn, WrappedPrivateKeyColumn, CreatedAtColumn, UpdatedAtColumn}
