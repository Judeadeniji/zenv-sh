...
function MenubarContent({
  ...
  return (
    <DropdownMenuContent
      ...
      className={cn("min-w-36 rounded-lg bg-popover p-1 text-popover-foreground border-0 shadow-[var(--shadow-menu),0px_0px_0px_1px_var(--border-alpha-100)] duration-100 data-[side=bottom]:slide-in-from-top-2 data-[side=inline-end]:slide-in-from-left-2 data-[side=inline-start]:slide-in-from-right-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95", className )}
      {...props}
    />
  )
}
...
function MenubarSubContent({
  ...
  return (
    <DropdownMenuSubContent
      ...
      className={cn("min-w-32 rounded-lg bg-popover p-1 text-popover-foreground border-0 shadow-[var(--shadow-menu),0px_0px_0px_1px_var(--border-alpha-100)] duration-100 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95", className )}
      {...props}
    />
  )
}
